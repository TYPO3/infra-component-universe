...
export class Universe extends LitElement {
    ...
    render() {
        ...
        const entries : Menu = {
            ...
            'demo': {
                'label': 'Demo',
                'icon': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g fill="currentColor"><path d="M12.8,3.4c-1.3-0.5-2.9-0.2-4.1,0.5c0.3-1.3,0.8-2.7,0.8-2.7L8.5,0.8c0,0.1-0.7,1.7-0.9,3.2 c-1.3-0.8-3-1.2-4.4-0.7C0.6,4.4-0.4,7.9,1,11.2c0.7,1.8,2,3.2,3.6,3.9c1.1,0.5,2.3,0.5,3.4,0.1c0,0,0,0,0,0c0.5,0.2,1,0.3,1.5,0.3 c0.6,0,1.2-0.1,1.8-0.4c1.6-0.7,2.9-2.1,3.7-3.9C16.4,7.9,15.3,4.4,12.8,3.4z M14.1,10.8c-0.6,1.6-1.8,2.8-3.1,3.4 c-0.9,0.4-1.8,0.4-2.6,0.1c-0.1-0.1-0.3-0.2-0.4-0.2c-0.1,0-0.2,0-0.2,0.1l-0.1,0.1c-0.8,0.3-1.7,0.3-2.7-0.1 c-1.3-0.6-2.5-1.8-3.1-3.4C0.8,8.1,1.6,5.1,3.6,4.3c1.1-0.4,2.8,0,4.1,1L8,5.5l0.3-0.2c1.1-0.8,2.8-1.5,4.1-1 C14.5,5.1,15.2,8.1,14.1,10.8z"/><path d="M12.1,5.1c-0.3-0.1-0.6-0.2-0.9-0.2c-0.7,0-1.4,0.3-2.1,0.8C8.5,6.1,8.2,6.8,8.2,7.5l-0.1,5 c0,0.4,0.2,0.8,0.6,1c0.3,0.1,0.6,0.2,0.9,0.2c0.5,0,1.1-0.2,1.5-0.5c1-0.6,1.8-1.6,2.2-2.7v0C14.3,8.2,13.7,5.7,12.1,5.1z M12.4,10.2c-0.3,0.9-1,1.7-1.9,2.2c-0.3,0.2-0.6,0.3-1,0.3c-0.2,0-0.3,0-0.5-0.1c0,0,0,0,0,0l0.1-5c0-0.4,0.2-0.8,0.5-1 c0.5-0.4,1-0.6,1.5-0.6c0.2,0,0.4,0,0.5,0.1c0.4,0.2,0.7,0.6,0.8,0.9C12.9,7.8,12.9,9,12.4,10.2z"/></g></svg>',
